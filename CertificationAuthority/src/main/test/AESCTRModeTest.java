...
public class AESCTRModeTest {
    ...
    public static void main(String[] args) {
        ...
        // 加密
        byte[] encryptedText = AESCTR.process(plainText, key, iv);

        // 打印加密后的密文
        System.out.println("加密后的密文: " + bytesToHex(encryptedText));

        // 解密（使用相同的函数，因为CTR模式的加密和解密是对称的）
        byte[] decryptedText = AESCTR.process(encryptedText, key, iv);
